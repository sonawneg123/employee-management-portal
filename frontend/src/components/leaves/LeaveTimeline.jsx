          ...
          {[0, 1, 2].map((i) => (
            <Box key={i} sx={{ display: 'flex', gap: 2, mb: 3 }}>
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Skeleton variant="rectangular" width={80} height={20} sx={{ mt: 0.5, borderRadius: 4 }} />
              </Box>
            </Box>
          ))}
        </CardContent>
      ...
      <Card>
        <CardContent>
          ...
          <Box sx={{ py: 4, textAlign: 'center', color: 'text.disabled' }}>
            ...
            <Typography variant="body2" sx={{ mt: 1 }}>No leave history.</Typography>
          </Box>
        </CardContent>
      </Card>
    );
      ...
      <CardContent>
        ...
        <Box sx={{ position: 'relative' }}>
          ...
          {leaves.map((leave, idx) => (
            <Box key={leave.id} sx={{ display: 'flex', gap: 2, mb: 3, position: 'relative', zIndex: 1 }}>
              {/* Dot */}
              <Box sx={{
