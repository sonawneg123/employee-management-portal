...
describe('TaskStatusChip', () => {
  it('renders ASSIGNED status', () => {
    render(
      <Wrap>
        <TaskStatusChip status="ASSIGNED" />
      </Wrap>,
    );
  ...
  it('renders IN_PROGRESS status', () => {
    render(
      <Wrap>
        <TaskStatusChip status="IN_PROGRESS" />
      </Wrap>,
    );
  ...
  it('shows Overdue when overdue=true and status is not COMPLETED', () => {
    render(
      <Wrap>
        <TaskStatusChip status="ASSIGNED" overdue={true} />
      </Wrap>,
    );
  ...
  it('does NOT show Overdue when status is COMPLETED even if overdue=true', () => {
    render(
      <Wrap>
        <TaskStatusChip status="COMPLETED" overdue={true} />
      </Wrap>,
    );
    expect(screen.getByText('Completed')).toBeInTheDocument();
  ...
  it('renders CHANGES_REQUESTED status', () => {
    render(
      <Wrap>
        <TaskStatusChip status="CHANGES_REQUESTED" />
      </Wrap>,
    );
